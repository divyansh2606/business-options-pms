...
export default function Sidebar({ user, activeTab, setActiveTab, onLogout, isOpen, onClose }) {
  ...
  const menuItems = [
    ...
    { id: "productionSummary", label: "Production Summary", icon: "📈" },
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <div className={`
        fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-indigo-900 to-purple-900 text-white shadow-2xl z-50
      ...
      `}>
        <div className="flex flex-col h-full overflow-hidden p-6 relative">
          ...
          {/* Logo/Brand Section */}
          <div className="mb-8 flex-shrink-0 mt-2 md:mt-0">
